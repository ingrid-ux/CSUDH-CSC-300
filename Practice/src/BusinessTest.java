...
public class BusinessTest
{
	public static void main(String [] args) throws IOException
	{
		...
		for(Executive execI : executiveAL)
		{
			...
			{
				outputWriter.printf("%-15s%-10d\n", execI.getManagedEmployeeAtIndex(i).getName(), execI.getManagedEmployeeAtIndex(i).getID());
			}
			outputWriter.printf("\n");
		}
		...
		for(Manager mgrI : managerAL)
		{
			...
			for (int i = 0; i < size; i++)
			{
				outputWriter.printf("%-15s%-10d\n", mgrI.getManagedEmployeeAtIndex(i).getName(), mgrI.getManagedEmployeeAtIndex(i).getID());
			}
			outputWriter.printf("\n");
		}
